$(document).ready(function () {
    ...
    var table = $('#tabla').DataTable({
        ...
        "columnDefs": [
            ...
            { "name": "IdMarca", "data": "idMarca", "targets": 0, "visible": true }, // Columna para IdMarca
        ...
        "order": [[0, "desc"]], // Ordenar por la primera columna (IdMarca) de forma descendente
        "language": {
    ...
    `;
        ...
        if (json != null) {
            $("#IdMarca").val(json.idMarca); // Asegúrate de usar los nombres correctos
    ...
    $(document).on('click', '.btn-editar', function (event) {
        ...
        $("#IdMarca").val(rowData.idMarca); // Asigna el ID al campo oculto

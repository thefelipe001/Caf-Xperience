$(document).ready(function () {
    ...
    function cargarCampus() {
        $.ajax({
            url: window.location.origin + "/ReporteRenta/DataCampus", // Asegúrate de que esta URL sea correcta
            type: "POST",
            dataType: "json",
    ...
    // Llamar a la función cargarCampus cuando sea necesario, como al hacer clic en un botón
    cargarCampus();
    ...
    // Consultar el Campus
    function cargarProvedor() {
        $.ajax({
            url: window.location.origin + "/ReporteRenta/DataProvedor", // Asegúrate de que esta URL sea correcta
            type: "POST",
            dataType: "json",
            success: function (response) {
                // Limpiar el select antes de agregar nuevas opciones, pero mantener la opción inicial
    ...
    // Llamar a la función cargarProvedor cuando sea necesario, como al hacer clic en un botón
    cargarProvedor();
